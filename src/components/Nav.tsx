  ...
  return (
    <nav className="sticky top-0 z-30 border-b border-border-light dark:border-border-dark bg-surface/90 dark:bg-surface-dark/90 backdrop-blur-md">
      <div className="flex items-center justify-between px-5 md:px-9 py-3.5">
        <div className="font-hero text-2xl font-extrabold tracking-tight">
          TA
        </div>
        ...
        <div className="flex bg-card dark:bg-card-dark rounded-full p-1 relative">
          ...
          <button
            ...
            className={`relative z-10 px-4 md:px-6 py-2 md:py-2.5 text-xs md:text-sm font-semibold rounded-full transition-colors ${
              route === "software"
                ? "text-white"
